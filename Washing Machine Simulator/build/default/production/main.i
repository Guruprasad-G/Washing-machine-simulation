...
void main(void) {
    ...
    clcd_print(" Press Key5 To  ", (0x80 + 0));
    clcd_print("    Power ON    ", (0xC0 + 0));
...
void water_level_display(unsigned char key)
{
    ...
    if(water_level_index <= 2)
    {
        ...
        clcd_print(water_level_arr[water_level_index + 1], (0x90 + 2));
        clcd_print(water_level_arr[water_level_index + 2], (0xD0 + 2));
    }
    else if(water_level_index == 3)
    {
        clcd_print(water_level_arr[water_level_index], (0xC0 + 2));
        clcd_print(water_level_arr[water_level_index + 1], (0x90 + 2));
        clcd_print(water_level_arr[0],(0xD0 + 2));
    }
     else if(water_level_index == 4)
    {
        clcd_print(water_level_arr[water_level_index], (0xC0 + 2));
        clcd_print(water_level_arr[0], (0x90 + 2));
        clcd_print(water_level_arr[1], (0xD0 + 2));
    }
}
